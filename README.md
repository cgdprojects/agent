...
The enso documentation is available [here](https://docs.laravel-enso.com) split into backend and frontend.
Note that most sections have short demo clips.

### Installation Steps

1. Download the project with `git clone https://github.com/cgdprojects/agent.git --depth 1`
...
6. Launch the site and log into the project with user: `admin@laravel-enso.com`, password: `password`
...
Built with with <span style="color:red"> &#10084;&#65039;</span>, crafted on Laravel 9.x:
